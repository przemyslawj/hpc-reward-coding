...
rootDir = '/mnt/DATA/Prez/cheeseboard/2019-08/habituation/';
dateStr = '2019-08-28';
...
for session_i = 1:numel(sessionDirs)
    ...
    filtTraceBySession = mat2cell(ms.FiltTraces, sessionLengths);
    ...
    filtTraceData = mergeByTimestamp(trialPositions, (filtTraceBySession{session_i})', sessionTimestamps);
    sessionData.filtTrace = filtTraceData.trace(taskStartedIndecies,:);
