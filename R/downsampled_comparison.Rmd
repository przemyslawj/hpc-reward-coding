...
save.image(file="data/downsampled_deconv_bin200msec_nbins20_occupancy07sec_gaussvar2.RData")
```
...
summary.df = summarize.downrew.pc.pct(down.rewdist, dist.threshold=15) %>%
  ...
  #filter(animal_beforetest_day %in% tests.passed$animal_beforetest_day) 
...
plot.val.change.between.groups(create.animal.summary(summary.df, pct.reward, exp_title), 
