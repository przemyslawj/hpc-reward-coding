...
odd.field = create.pf.df(f1, oc1, max.xy=nbins)
even.field = create.pf.df(f2, oc2, max.xy=nbins)
...
day = '2019-08-31'
cell_name = 9
root_dir = '/home/przemek/neurodata/cheeseboard-down/down_2/2019-08'
#cell_name = 47
...
binned.cell.df = bin.time.space(cell.df, 
                                nbins.x = nbins,
                                nbins.y = nbins,
                                bin.quantile.fractions=c(0.9, 1.0),
