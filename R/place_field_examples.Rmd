...
detect.events(data.traces.run)
cell.df = data.traces.run[cell_id == cell_name
                          & smooth_trans_x >= 0 & smooth_trans_y >= 0
...
binned.cell.df = timebin.traces(cell.df,
                                timebin.dur.msec = 200,
                                xybins = getNBinsXY(),
                                trace.var = deconv_trace)
plot.cell.trials(binned.cell.df)
```
