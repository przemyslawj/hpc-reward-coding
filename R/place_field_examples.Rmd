...
animal_name = 'E-TR'
g.etr = bind_rows(
  create.all.day.pf(create.selected.pf.df(animal_name, 89), T),
  create.all.day.pf(create.selected.pf.df(animal_name, 90), T),
  create.all.day.pf(create.selected.pf.df(animal_name, 99), T),
  create.all.day.pf(create.selected.pf.df(animal_name, 122), T),
...
g.gbr
ggsave('/tmp/pf_ggbr.svg', plot = g.gbr, width = 22, height = 12, units = 'cm')
```
