...
#day = '2020-02-05' # learning 1 day5
...
behav.traces.fragment = behav.traces[trial==selected.trial & timestamp>=9700 & is_running]
...
rew.aligned.traces = binned.traces[exp_title=='trial' & trial == selected.trial, 
                                   center.timestamps.around.events(.SD, reward.arriving.bouts[trial == selected.trial], 
                                                                   ...
                                                                   padding.after.event=5000/timebin.dur.msec), 
                                   by=.(exp_title, trial_id, cell_id)][aligned_event_id >= 0,]
rew.aligned.traces.fragment = rew.aligned.traces[timestamp_from_start >= 0 & timestamp_from_end <= 5000]
gs = plot.approaches(rew.aligned.traces.fragment,
                     rew.aligned.traces.fragment$trial_id[1], 
                     return.plots = TRUE, cell.active.thr = 0.5, 
...
ggsave('/tmp/beforetest_approaches.png',
      cowplot::plot_grid(plotlist=g.approaches, ncol = 3), height=nrows*7, width=15, units='cm')
```
