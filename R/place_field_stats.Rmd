...
spatial.info.model = lmer(log(spatial.information) ~ implant + (1 | animal), data=compared.pcs.df, REML=TRUE)
...
field.size.model = lmer(early.late.cor ~ implant + (1 | animal), data=compared.pcs.df, REML=TRUE)
...
plot.model.diagnostics(field.cor.model, pc.nextday.unchanged$animal, pc.nextday.unchanged$stage)
```
