...
test.trial.df = df %>%
  mutate(learning_day1_f = as.factor(learning_day1),
         ...
         norm_crossings_30s=crossings_0_30s * 100.0 / dist_0_30s,
         norm_crossings_60s=crossings_0_60s * 100.0 / dist_0_60s,
         norm_crossings_120s=crossings_0_120s * 100.0 / dist_0_120s) %>%
  filter(exp_title == 'beforetest') 
