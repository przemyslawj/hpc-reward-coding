...
```{r}
cell.overlap.df %>%
  dplyr::mutate(day1.str=format(day1), day2.str=format(day2)) %>%
  left_join(trials.meta.df, by=c('animal'='animal', 'day1.str'='date')) %>% 
  dplyr::rename(day_desc1 = day_desc) %>% 
  left_join(trials.meta.df, by=c('animal'='animal', 'day2.str'='date')) %>% 
